...
> 上层规范: `../../../.claude/CLAUDE.md`
> 基线: Mooncake `upstream-v0.3.13`；定制分支: `upstream-v0.3.13-flatcake-b200`。
> 以下保留 v0.3.10 项目规范作为背景；代码行号、数据格式和接口细节以 v0.3.13 实现为准。
> 本次仅迁移六个 Flatcake 提交，不改造上游分配、淘汰或传输架构。
